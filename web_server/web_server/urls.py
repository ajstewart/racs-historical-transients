...
urlpatterns = [
    ...
    url(r'^image/(?P<pk>\d+)/crossmatches/$', views.image_crossmatch_query, name='image_crossmatches'),
    url(r'^image/(?P<pk>\d+)/crossmatches/quickview/$', views.crossmatch_quickview, name='crossmatch_quickview'),
    url(r'^image/(?P<pk>\d+)/crossmatches/(?P<cross_id>\d+)/$', views.image_crossmatches_detail, name='image_crossmatches_detail'),
